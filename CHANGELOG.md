...
- **configure:** validate rules and checks properties ([#2293](https://github.com/dequelabs/axe-core/issues/2293)) ([decfe9d](https://github.com/dequelabs/axe-core/commit/decfe9d315f61a1bc601c8fb2b7fd8a7facf0fb5))
...
- **is-visible:** return false for opacity: 0 and 0 height scrollable regions ([#2283](https://github.com/dequelabs/axe-core/issues/2283)) ([c764713](https://github.com/dequelabs/axe-core/commit/c764713887ee6b0a7d2ad7e50ce113e0764f16d9))
...
- **aria-allowed-role:** allow role=spinbutton on input[type=tel](<[3ffc0e4](https://github.com/dequelabs/axe-core/commit/3ffc0e4782fa606a619f304e345a6fd314a5c9db)>)
...
- **color-contrast:** ignore form elements that move text outside of node using text-indent ([#2044](https://github.com/dequelabs/axe-core/issues/2044)) ([104834f](https://github.com/dequelabs/axe-core/commit/104834fdc1fd09f5bb002ae48709f8939c0c7864))
...
- **color-contrast:** parse font-weight value as number ([#2031](https://github.com/dequelabs/axe-core/issues/2031)) ([#2040](https://github.com/dequelabs/axe-core/issues/2040)) ([72a5a82](https://github.com/dequelabs/axe-core/commit/72a5a8218846714470274fa42fbe7bb161b79fd8))
...
- **color-contrast:** properly pass options to check ([#2033](https://github.com/dequelabs/axe-core/issues/2033)) ([3b65eec](https://github.com/dequelabs/axe-core/commit/3b65eec5611234d8e8ea5bfef854ae2f86b93315))
- **commons:** handle node(s) contained by SVG document when de… ([#2054](https://github.com/dequelabs/axe-core/issues/2054)) ([41786b5](https://github.com/dequelabs/axe-core/commit/41786b56206faca17505b1968f57e20353cfc285))
- **commons:** avoid unicode regex encoding in axe.min.js ([#2024](https://github.com/dequelabs/axe-core/issues/2024)) ([504d912](https://github.com/dequelabs/axe-core/commit/504d9121c5eaa33992d214533dd4b3126cca0923))
...
- **getCheckMessage:** add API to return check message ([#2066](https://github.com/dequelabs/axe-core/issues/2066)) ([bcfa400](https://github.com/dequelabs/axe-core/commit/bcfa40063605efe5dd5c62da1b3a74425721bb6f))
- **has-lang:** fail check when `xml:lang` is used in HTML docum… ([#2053](https://github.com/dequelabs/axe-core/issues/2053)) ([414cd09](https://github.com/dequelabs/axe-core/commit/414cd09298dd0edce1d54bb159271d35103f70e6))
- **has-lang:** update message to indicate that xml:lang is not valid on HTML pages ([4023f9d](https://github.com/dequelabs/axe-core/commit/4023f9d83c9018a843a2caa9457a26092a0afd5e))
- **header-present:** update verbiage to use heading instead of header ([8bc01ec](https://github.com/dequelabs/axe-core/commit/8bc01ecfa54987e291d6766714d4acd9339c2ab6))
- **label-content-name-mismatch:** ignore non `widget` aria role(s) & do not use deprecated `lookupTable.rolesOfType` ([#2022](https://github.com/dequelabs/axe-core/issues/2022)) ([3b519a6](https://github.com/dequelabs/axe-core/commit/3b519a6a70ef98573cf13b9b89fc032ed73df4cc))
...
- **meta-viewport:** parse negative and string values for `maxim… ([#2137](https://github.com/dequelabs/axe-core/issues/2137)) ([8c92472](https://github.com/dequelabs/axe-core/commit/8c92472397676d44b333cf50ad1a9413b9783c2c))
- **package-lock:** change @deque/doT from agora to npm ([#2058](https://github.com/dequelabs/axe-core/issues/2058)) ([ff85972](https://github.com/dequelabs/axe-core/commit/ff85972476bc36069967124d1939c1dff17f4926))
- **page-has-heading-one:** find screen-reader only headings ([#2065](https://github.com/dequelabs/axe-core/issues/2065)) ([4c4c41a](https://github.com/dequelabs/axe-core/commit/4c4c41ab7493f147360d4a3959f9dbaf03b0f7b7))
- **page-no-duplicate-contentinfo:** do not fail when first footer is inside article ([c8331a3](https://github.com/dequelabs/axe-core/commit/c8331a304ce45af78d95745f03a0e90688e246df))
- **region:** ignore direct child text nodes of body ([#2050](https://github.com/dequelabs/axe-core/issues/2050)) ([af6899e](https://github.com/dequelabs/axe-core/commit/af6899e9043f85f4881b324104b56092ba0a6cc3))
...
- **respondable:** ignore reflected messages from iframes ([10adf5e](https://github.com/dequelabs/axe-core/commit/10adf5e8e9c50c4fc902fa1521529e2f8c9350f3))
...
- **skip-link:** identify as skip-link only if the link is offscreen ([#2079](https://github.com/dequelabs/axe-core/issues/2079)) ([ab5a011](https://github.com/dequelabs/axe-core/commit/ab5a011e72f6cbf1c2ba68ddf96aa4df9e0cd3b8))
- **sri-history:** correct SRI for various versions ([#2041](https://github.com/dequelabs/axe-core/issues/2041)) ([c36ccc5](https://github.com/dequelabs/axe-core/commit/c36ccc5f51d057abd8097dbba5e2a58bc6642be2))
- **td-has-headers:** don't fail for empty headers attribute ([6d7cb0f](https://github.com/dequelabs/axe-core/commit/6d7cb0fe6d07c9f6d55f0df2c5d05ccb01708413))
- **td-headers-attr:** mark as needs review if headers attr is empty ([07c8055](https://github.com/dequelabs/axe-core/commit/07c8055ca82c14805ae2258ffbb0e4475773c18d))
...
- check `invaildrole` fails only when all roles are invalid ([#2075](https://github.com/dequelabs/axe-core/issues/2075)) ([74c55f2](https://github.com/dequelabs/axe-core/commit/74c55f262640e92b7e95618280cee0bbe2b0a4bc))
- ignore empty, whitespace or undefined `role` for rule `ari… ([#2077](https://github.com/dequelabs/axe-core/issues/2077)) ([a7ac380](https://github.com/dequelabs/axe-core/commit/a7ac38044ce934301daf520ddc7fd953e3de7d84))
- update tags for rule `area-alt` ([#2051](https://github.com/dequelabs/axe-core/issues/2051)) ([0ec5091](https://github.com/dequelabs/axe-core/commit/0ec5091187821207e426190c65493935a782d293))
